...
echo "Granting permissions to Cloud Run Service Agent (${RUN_SA})..."
gcloud projects add-iam-policy-binding $PROJECT_ID --member="serviceAccount:${RUN_SA}" --role="roles/compute.networkUser"
